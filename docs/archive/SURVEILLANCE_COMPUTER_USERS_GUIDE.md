...
> **Current guides:** [IMPLEMENTATION_GUIDE.md](../../IMPLEMENTATION_GUIDE.md) (technical consultant) · [FRP_OPERATIONS_GUIDE.md](../../FRP_OPERATIONS_GUIDE.md) (FRP, dashboard-only).  
